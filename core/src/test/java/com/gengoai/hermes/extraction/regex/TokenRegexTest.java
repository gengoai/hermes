...
public class TokenRegexTest {
   ...
   public void setUp() throws Exception {
      ...
      //Add basic POS
      document.tokenAt(0).put(Types.PART_OF_SPEECH, PartOfSpeech.NOUN);
      document.tokenAt(1).put(Types.PART_OF_SPEECH, PartOfSpeech.VERB);
      document.tokenAt(2).put(Types.PART_OF_SPEECH, PartOfSpeech.NOUN);
      document.tokenAt(3).put(Types.PART_OF_SPEECH, PartOfSpeech.ADPOSITION);
      document.tokenAt(4).put(Types.PART_OF_SPEECH, PartOfSpeech.DETERMINER);
      document.tokenAt(5).put(Types.PART_OF_SPEECH, PartOfSpeech.NOUN);
      document.tokenAt(6).put(Types.PART_OF_SPEECH, PartOfSpeech.ADPOSITION);
      document.tokenAt(7).put(Types.PART_OF_SPEECH, PartOfSpeech.NUMERAL);
      document.tokenAt(8).put(Types.PART_OF_SPEECH, PartOfSpeech.NOUN);
      document.tokenAt(9).put(Types.PART_OF_SPEECH, PartOfSpeech.PUNCTUATION);
   ...
   public void testLookAhead() throws Exception {
      ...
      //Negative lookahead
      matcher = TokenRegex.compile("( /^john$/i | /^sally$/i ) (?!> #NUMERAL)").matcher(document);
      assertTrue(matcher.find());
      assertEquals("John", matcher.group().toString());
      assertTrue(matcher.find());
      assertEquals("Sally", matcher.group().toString());
