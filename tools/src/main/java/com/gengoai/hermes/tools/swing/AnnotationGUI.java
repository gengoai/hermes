...
public class AnnotationGUI extends HermesGUI {
   ...
   protected void initControls() throws Exception {
      ...
      AnnotationLayer annotationLayer = Json.parseObject(Resources.fromClasspath("annotation/layers/entities.json"),
                                                         AnnotationLayer.class);

      var tbPane = new JTabbedPane();
      tbPane.addTab("Corpus", new CorpusView("/data/news_1m_sentences", Corpus.open("/data/news_1m_sentences")));

      var d2 = Document.create("President Donald Trump is preparing to announce a second coronavirus task force solely focused on reopening the nation's economy, multiple sources told CNN.\n" +
                                     "\n" +
