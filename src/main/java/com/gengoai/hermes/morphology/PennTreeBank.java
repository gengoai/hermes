...
import static com.gengoai.hermes.morphology.POSTagSetManager.create;
import static com.gengoai.hermes.morphology.UPos.*;
...
public final class PennTreeBank {
   ...
   public static final PartOfSpeech NP = create("NP", "NP", PartOfSpeech.NOUN, true);
