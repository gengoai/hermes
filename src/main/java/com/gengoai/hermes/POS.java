...
public enum POS implements Tag {
   ...
   private final com.gengoai.hermes.POS parentType;

   POS(com.gengoai.hermes.POS parentType, String tag) {
    ...
    */
   public static com.gengoai.hermes.POS fromString(String tag) {
    ...
    */
   public static com.gengoai.hermes.POS forText(HString text) {
      ...
      com.gengoai.hermes.POS tag = ANY;
    ...
    */
   public com.gengoai.hermes.POS getParentType() {
    ...
    */
   public com.gengoai.hermes.POS getUniversalTag() {
      if (this == ANY) {
         return ANY;
      }
      com.gengoai.hermes.POS tag = this;
   ...
   public boolean isInstance(Tag tag) {
      ...
      if (tag == com.gengoai.hermes.POS.ANY) {
         return true;
      }
      if (tag instanceof com.gengoai.hermes.POS) {
         com.gengoai.hermes.POS other = (com.gengoai.hermes.POS) tag;
         com.gengoai.hermes.POS check = this;
         while (check != null) {
            if (check == other) {
               return true;
            }
